...
const YourLibraryScreen = () => {
  ...
  const artist = {
    ...
    profilePic: require('../assets/My Library/Image 107.png'), // Đường dẫn ảnh của nghệ sĩ
  };

  // Dữ liệu bài hát với hình ảnh
  const allSongsData = [
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      {/* Bottom Navigation */}
      <View style={{ flexDirection: 'row', justifyContent: 'space-around', paddingVertical: 8, borderTopWidth: 1, borderColor: '#ddd' }}>
        <TouchableOpacity>
          <Text>🏠</Text>
        </TouchableOpacity>
        <TouchableOpacity>
